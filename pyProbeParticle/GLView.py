...
class GLView:
    def __init__(self, wh=(800, 600)):
        ...
        self.libSDL = ctypes.CDLL(
            "/usr/lib/x86_64-linux-gnu/libSDL2.so", ctypes.RTLD_GLOBAL
        )
        self.libGL = ctypes.CDLL(
            "/usr/lib/x86_64-linux-gnu/libGL.so", ctypes.RTLD_GLOBAL
        )
