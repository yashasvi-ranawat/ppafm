...
zmin = round(max(atoms0[3]), 1)
zmax = round(lvec0[3][2], 1)
ymax = round(lvec0[1][1] + lvec0[2][1], 1)
xmax = round(lvec0[1][0] + lvec0[2][0], 1)
...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.figCan = guiw.FigImshow(
            parentWiget=self.main_widget, parentApp=self, width=5, height=4, dpi=100
        )
        ...
        self.slDataView = sl
        vb.addWidget(sl)
        sl.addItem(DataViews.FFpl.name)
        sl.addItem(DataViews.FFel.name)
        sl.addItem(DataViews.FFin.name)
        sl.addItem(DataViews.FFout.name)
        sl.addItem(DataViews.df.name)
        ...
        bx.setRange(0, 200)
        bx.setValue(8)
        bx.valueChanged.connect(self.updateFromFF)
        vb.addWidget(bx)
        self.bxZPP = bx
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(0.25, 4.0)
        bx.setValue(1.00)
        bx.setSingleStep(0.05)
        bx.valueChanged.connect(self.updateFromFF)
        vb.addWidget(bx)
        self.bxMorse = bx
        ...
        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("Q [e]"))
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(-2.0, 2.0)
        bx.setValue(self.Q)
        bx.setSingleStep(0.05)
        bx.valueChanged.connect(self.upload_and_relax)
        vb.addWidget(bx)
        self.bxQ = bx

        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("K {x,y,R} [N/m]"))
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(0.0, 2.0)
        bx.setValue(0.24)
        bx.setSingleStep(0.05)
        bx.valueChanged.connect(self.relax)
        vb.addWidget(bx)
        self.bxKx = bx
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(0.0, 2.0)
        ...
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(0.0, 100.0)
        bx.setValue(30.0)
        bx.setSingleStep(5.0)
        bx.valueChanged.connect(self.relax)
        vb.addWidget(bx)
        self.bxKr = bx
        ...
        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("eq.pos {x,y,R} [A]"))
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(-2.0, 2.0)
        bx.setValue(0.0)
        ...
        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("relax_min {x,y,z}[A]"))
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(-100.0, 100.0)
        bx.setValue(0.0)
        bx.setSingleStep(0.1)
        bx.valueChanged.connect(self.shapeRelax)
        vb.addWidget(bx)
        self.bxSpanMinX = bx
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(-100.0, 100.0)
        ...
        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("relax_max {x,y,z}[A]"))
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(0.0, 100.0)
        bx.setValue(xmax)
        bx.setSingleStep(0.1)
        ...
        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("relax_step {x,y,z}[A]"))
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(0.02, 0.5)
        bx.setValue(0.1)
        bx.setSingleStep(0.02)
        bx.valueChanged.connect(self.shapeRelax)
        vb.addWidget(bx)
        self.bxStepX = bx
        bx = QtWidgets.QDoubleSpinBox()
        ...
        vb.addWidget(
            QtWidgets.QLabel(
                "In the beginning & after chaging anything rather push relax"
            )
        )
        ...
        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("{ iz (down from top), nAmp }"))
        bx = QtWidgets.QSpinBox()
        bx.setRange(-300, 500)
        bx.setSingleStep(1)
        bx.setValue(0)
        bx.valueChanged.connect(self.updateDataView)
        vb.addWidget(bx)
        self.bxZ = bx
        bx = QtWidgets.QSpinBox()
        bx.setRange(0, 50)
        bx.setSingleStep(1)
        bx.setValue(10)
        bx.valueChanged.connect(self.F2df)
        vb.addWidget(bx)
        self.bxA = bx

        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("{ k[kN/m], f0 [kHz] }"))
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(0, 1000.0)
        bx.setSingleStep(0.1)
        bx.setValue(1.8)
        bx.valueChanged.connect(self.F2df)
        vb.addWidget(bx)
        self.bxCant_K = bx
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(0, 2000.0)
        bx.setSingleStep(1.0)
        bx.setValue(30.3)
        bx.valueChanged.connect(self.F2df)
        vb.addWidget(bx)
        self.bxCant_f0 = bx
    ...
    def shapeRelax(self):
        step = np.array(
            [
                float(self.bxStepX.value()),
                float(self.bxStepY.value()),
                float(self.bxStepZ.value()),
            ]
        )
        rmin = np.array(
            [
                float(self.bxSpanMinX.value()),
                float(self.bxSpanMinY.value()),
                float(self.bxSpanMinZ.value()),
            ]
        )
        rmax = np.array(
            [
                float(self.bxSpanMaxX.value()),
                float(self.bxSpanMaxY.value()),
                float(self.bxSpanMaxZ.value()),
            ]
        )
        ...
        if self.FF is not None:
            self.composeTotalFF()
        self.relax_poss = oclr.preparePoss(
            self.relax_dim, z0=rmax[2], start=rmin, end=rmax
        )
    ...
    def updateFF(self):
        ...
        Zs, xyzs, qs = PPU.PBCAtoms(
            Zs, xyzs, qs, avec=self.lvec[1], bvec=self.lvec[2], na=pbcnx, nb=pbcnx
        )
        ...
        if self.perAtom:
            ...
            REAs = PPU.combineREA(
                PP_R, PP_E, atomREAs[:, 4:7], alphaFac=self.bxMorse.value()
            )
            ...
            REAs = PPU.getAtomsREA(
                iZPP, Zs, self.TypeParams, alphaFac=-self.bxMorse.value()
            )
        ...
        self.ff_args = FFcl.updateArgsMorse(
            self.ff_args, self.atoms, self.REAs, self.poss
        )
    ...
    def loadInputs_New(self):
        ...
        try:
            with open("atomtypes.ini", "r") as f:
                self.str_Species = f.read()
        except:
        ...
        self.str_Species = "\n".join(
            "\t".join(l.split()[:5]) for l in self.str_Species.split("\n")
        )
        self.TypeParams = PPU.loadSpeciesLines(self.str_Species.split("\n"))
        ...
        lines = [
            "%i %f %f %f %f"
            % (atoms[0][i], atoms[1][i], atoms[2][i], atoms[3][i], atoms[4][i])
        ...
        self.FFel = FFcl.XYZ2float4(
            FFel[:, :, :, 0], FFel[:, :, :, 1], FFel[:, :, :, 2]
        )
    ...
    def getFF(self):
        ...
        self.plot_FF = True
        t2 = time.clock()
        print("FFcl.func_runFF time %f [s]" % (t2 - t1))
        # self.plotSlice()
        self.updateDataView()
    ...
    def relax(self):
        ...
        stiffness = np.array(
            [self.bxKx.value(), self.bxKy.value(), 0.0, self.bxKr.value()],
            dtype=np.float32,
        )
        stiffness /= -16.0217662
        # print "stiffness", stiffness
        dpos0 = np.array(
            [self.bxP0x.value(), self.bxP0y.value(), 0.0, self.bxP0r.value()],
            dtype=np.float32,
        )
        dpos0[2] = -np.sqrt(dpos0[3] ** 2 - dpos0[0] ** 2 + dpos0[1] ** 2)
        # print "dpos0", dpos0
        relax_params = np.array([0.1, 0.9, 0.1 * 0.2, 0.1 * 5.0], dtype=np.float32)
        # print "relax_params", relax_params
        self.FEout = oclr.relax(
            self.relax_args,
            self.relax_dim,
            self.invCell,
            poss=self.relax_poss,
            dpos0=dpos0,
            stiffness=stiffness,
            relax_params=relax_params,
        )
        t2 = time.clock()
        print("oclr.relax time %f [s]" % (t2 - t1))
        print("self.FEin.shape", self.FEin.shape)
    ...
    def composeTotalFF(self):
        ...
        if np.abs(self.Q) < 1e-4:
            ...
            if self.FFel is None:
                self.FEin[:, :, :, :] = (
                    self.FF[:, :, :, :4] + self.Q * self.FF[:, :, :, 4:]
                )
            else:
                print(self.FEin.shape, self.FF.shape, self.FFel.shape)
                self.FEin[:, :, :, :] = (
                    self.FF[:, :, :, :] + self.Q * self.FFel[:, :, :, :]
                )

    def upload_and_relax(self):
        self.composeTotalFF()
        region = self.FEin.shape[:3]
        region = region[::-1]
        print("upload FEin : ", region)
        cl.enqueue_copy(
            oclr.oclu.queue,
            self.relax_args[0],
            self.FEin,
    ...
    def F2df(self):
        ...
        if nAmp > 0:
            t1 = time.clock()
            self.df = -PPU.Fz2df(
                np.transpose(self.FEout[:, :, :, 2], (2, 1, 0)),
                dz=self.bxStepZ.value(),
                k0=self.bxCant_K.value() * 1e3,
                f0=self.bxCant_f0.value() * 1e3,
                n=nAmp,
            )
            t2 = time.clock()
            print("F2df time %f [s]" % (t2 - t1))
        else:
            self.df = None
        self.plot_FF = False
        # self.plotSlice()
    ...
    def saveFig(self):
        fileName, _ = QtWidgets.QFileDialog.getSaveFileName(
            self, "QFileDialog.getSaveFileName()", "", "Image files (*.png)"
        )
        if fileName:
    ...
    def saveDataW(self):
        fileName, _ = QtWidgets.QFileDialog.getSaveFileName(
            self, "QFileDialog.getSaveFileName()", "", "WSxM files (*.xyz)"
        )
        if fileName:
    ...
    def selectMode(self):
        ...
        if (self.mode == Modes.MorseFFel.name) or (
            self.mode == Modes.MorseFFel_pbc.name
        ):
    ...
    def updateDataView(self):
        ...
        try:
            ...
            self.figCan.plotSlice(
                data[iz],
                title=self.slDataView.currentText()
                + ":iz= "
                + str(int(self.bxZ.value())),
            )
        except:
            print("cannot plot slice #", iz)
        t2 = time.clock()
        print("plotSlice time %f [s]" % (t2 - t1))
    ...
    def clickImshow(self, ix, iy):
        ...
        self.figCurv.show()
        self.figCurv.figCan.plotDatalines(
            (list(range(len(ys))), ys, "%i_%i" % (ix, iy))
        )
