...
class MyDynamicMplCanvas(FigureCanvas):
    ...
    def plotSlice(self, F):
        ...
        self.img = self.axes.imshow(
            F, origin="image", cmap="gray", interpolation="nearest"
        )
...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        bx.setSingleStep(1)
        bx.setValue(90)
        bx.valueChanged.connect(self.plotSlice)
        vb.addWidget(bx)
        self.bxZ = bx
        bx = QtWidgets.QSpinBox()
        bx.setRange(0, 50)
        ...
        self.relax_poss = oclr.preparePoss(
            self.relax_dim, z0=16.0, start=(0.0, 0.0), end=(12.0, 12.0)
        )
    ...
    def loadInputs(self):
        ...
        self.TypeParams = PPU.loadSpecies(
            cpp_utils.PACKAGE_PATH + "/defaults/atomtypes.ini"
        )
