...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("relax {dt,damp}"))
        bx = QtWidgets.QDoubleSpinBox()
        bx.setRange(0.0, 10.0)
        bx.setValue(0.1)
        bx.setSingleStep(0.005)
        bx.valueChanged.connect(self.relax)
        vb.addWidget(bx)
        self.bx_dt = bx
        bx = QtWidgets.QDoubleSpinBox()
        ...
        vb = QtWidgets.QHBoxLayout()
        l0.addLayout(vb)
        vb.addWidget(QtWidgets.QLabel("{ iz, nAmp }"))
        bx = QtWidgets.QSpinBox()
        bx.setRange(0, 300)
        bx.setSingleStep(1)
        bx.setValue(10)
    ...
    def relax(self):
        ...
        # print "dpos0", dpos0
        relax_params = np.array(
            [
                self.bx_dt.value(),
                self.bx_damp.value(),
                self.bx_dt.value() * 0.2,
                self.bx_dt.value() * 5.0,
            ],
            dtype=np.float32,
        )
