...
parser.add_option(
    ...
    action="store",
    type="string",
    help="pixels (ix,iy) to take curve",
    default="curve_points.ini",
)
parser.add_option(
    "-i", action="store", type="string", help="input file", default="OutFz"
)
parser.add_option(
    "--iz", action="store", type="int", help="z-slice index to plot legend", default=15
)
