...
def loadInput():
    ...
    t1 = time.clock()
    cLJs_ = PPU.getAtomsLJ(8, Zs, FFparams)
    # print "C6_,C12_",C6_,C12_
    t2 = time.clock()
    print("getAtomsLJ time %f [s]" % (t2 - t1))

    atoms_ = FFcl.xyzq2float4(xyzs, qs)
    # print atoms_
...
Ftmp = np.zeros(nDim)
Ftmp[:, :, :] = FE[:, :, :, 0]
GU.saveXSF("ELJ_cl.xsf", Ftmp, lvec)
Ftmp[:, :, :] = FE[:, :, :, 1]
GU.saveXSF("FLJx_cl.xsf", Ftmp, lvec)
Ftmp[:, :, :] = FE[:, :, :, 2]
GU.saveXSF("FLJy_cl.xsf", Ftmp, lvec)
Ftmp[:, :, :] = FE[:, :, :, 3]
GU.saveXSF("FLJz_cl.xsf", Ftmp, lvec)
Ftmp[:, :, :] = FE[:, :, :, 4]
GU.saveXSF("Eel_cl.xsf", Ftmp, lvec)
Ftmp[:, :, :] = FE[:, :, :, 5]
GU.saveXSF("Felx_cl.xsf", Ftmp, lvec)
Ftmp[:, :, :] = FE[:, :, :, 6]
GU.saveXSF("Fely_cl.xsf", Ftmp, lvec)
Ftmp[:, :, :] = FE[:, :, :, 7]
GU.saveXSF("Felz_cl.xsf", Ftmp, lvec)
