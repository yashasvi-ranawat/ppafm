...
parser.add_option(
    "--krange", action="store", type="float", help="k parameter range", nargs=3
)
parser.add_option("-q", action="store", type="float", help="charge", default=0.0)
parser.add_option(
    "--qrange", action="store", type="float", help="charge range", nargs=3
)
parser.add_option("-a", action="store", type="float", help="amplitude", default=0.0)
parser.add_option(
    "--arange", action="store", type="float", help="amplitude range", nargs=3
)
