...
if os.path.exists(ParamFilename):
    ...
    print(
        "File {} with parameters doesn't exist!!! Using defaults".format(ParamFilename)
    )
...
if PP.params["useLJ"]:
    ...
    if exists:
        ...
        print(
            "I haven't found files containing LJ forcefields. Therefore I will recompute them from scratch"
        )
        todoLJ = "compute"
...
if PP.params["charge"] != 0.00:
    ...
    if exists:
        ...
        print(
            "I haven't found files containing electrostatic forcefields. Therefore I will recompute them from scratch"
        )
        todoEL = "compute"
